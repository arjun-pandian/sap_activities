...
def run_pmp_script():
    ...
    take_and_save_screenshot("pmp", "1_sm12")
    ...
    session.findById("wnd[0]").sendVKey(8)
    take_and_save_screenshot("pmp", "2_sm13")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsm21"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]").sendVKey(8)
    take_and_save_screenshot("pmp", "3_sm21")
    ...
    take_and_save_screenshot("pmp", "4_st22")
    ...
    try:
        ...
        take_and_save_screenshot("pmp", "5_sm37_1")
        total_job_time = 0
    ...
    try:
        ...
        session.findById("wnd[0]").sendVKey (2)
        session.findById("wnd[0]").sendVKey (41)
        take_and_save_screenshot("pmp", "6_sm37_2")
    except:
        take_and_save_screenshot("pmp", "6_sm37_2")
    ...
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pmp", "7_sm51")
    ...
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pmp", "8_sm66")


    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsmq1"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]").sendVKey(8)
    take_and_save_screenshot("pmp", "9_smq1")
    ...
    take_and_save_screenshot("pmp", "10_stms_1")
    ...
    take_and_save_screenshot("pmp", "13_db02")
    ...
    take_and_save_screenshot("pmp", "14_db12")


    session.findById("wnd[0]/tbar[0]/okcd").text = "/nal08"
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pmp", "15_al08")


    session.findById("wnd[0]/tbar[0]/okcd").text = "/nal11"
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pmp", "16_al11")
    ...
    take_and_save_screenshot("pmp", "17_tablespace")  
    ...
    # Write values into cells B3 to I3
    for index, value in enumerate(values):
        ws.cell(row=3, column=index+2, value=value) 
