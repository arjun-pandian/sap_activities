...
def run_pl5_script():
    ...
    #'''
    session.findById("wnd[0]/tbar[0]/okcd").text = "sm12"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/usr/txtSEQG3-GUNAME").text = "*"
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pl5", "1_sm12")
    ...
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pl5", "2_sm13")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsm21"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pl5", "3_sm21")
    ...
    take_and_save_screenshot("pl5", "4_st22")
    #'''
    ...
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pl5", "5_sm37_1")
    try :
    ...
    try :
        ...
        session.findById("wnd[0]").sendVKey (2)
        session.findById("wnd[0]").sendVKey (41) 
        take_and_save_screenshot("pl5", "6_sm37_2")
    except :
        take_and_save_screenshot("pl5", "6_sm37_2")
    #'''
    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsm51"
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pl5", "7_sm51")
    ...
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pl5", "8_smq1")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nstms"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/tbar[1]/btn[5]").press()
    session.findById("wnd[0]/usr/lbl[2,20]").setFocus()
    hovered_cell = session.findById("wnd[0]/usr/lbl[2,20]").Text
    take_and_save_screenshot("pl5", "9_stms_1")
    ...
    take_and_save_screenshot("pl5", "10_stms_2")
    ...
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pl5", "11_sm58")
    ...
    take_and_save_screenshot("pl5", "12_db02")
    ...
    take_and_save_screenshot("pl5", "13_db12")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nal08"
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pl5", "14_al08")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nal11"
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pl5", "15_al11")
    ...
    take_and_save_screenshot("pl5", "16_tablespace")
    ...
    # Write values into cells B5 to I5
    for index, value in enumerate(values):
        ws.cell(row=5, column=index+2, value=value) 
