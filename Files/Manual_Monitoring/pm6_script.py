...
def run_pm6_script():
    ...
    take_and_save_screenshot("pm6", "1_sm12")
    ...
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pm6", "2_sm13")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsm21"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pm6", "3_sm21")
    #'''
    ...
    take_and_save_screenshot("pm6", "4_st22")
    ...
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pm6", "5_sm37_1")
    try :
    ...
    try :
        ...
        session.findById("wnd[0]").sendVKey (2)
        session.findById("wnd[0]").sendVKey (41) 
        take_and_save_screenshot("pm6", "6_sm37_2")
    except :
        take_and_save_screenshot("pm6", "6_sm37_2")
    #'''
    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsm51"
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pm6", "7_sm51")
    ...
    session.findById("wnd[0]").sendVKey (0)
    take_and_save_screenshot("pm6", "8_sm66")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nsmq1"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/tbar[1]/btn[8]").press()
    take_and_save_screenshot("pm6", "9_smq1")

    session.findById("wnd[0]/tbar[0]/okcd").text = "/nstms"
    session.findById("wnd[0]").sendVKey (0)
    session.findById("wnd[0]/tbar[1]/btn[5]").press()
    session.findById("wnd[0]/usr/lbl[2,9]").setFocus()
    hovered_cell = session.findById("wnd[0]/usr/lbl[2,9]").Text
    take_and_save_screenshot("pm6", "10_stms_1")
    ...
    take_and_save_screenshot("pm6", "17_tablespace")
    ...
    # Write values into cells B8 to I8
    for index, value in enumerate(values):
        ws.cell(row=8, column=index+2, value=value) 
